...
builder.AddProject<Projects.BestDigiSellerApp_Basket_Api>("bestdigisellerapp-basket-api").WithReference(productApi).WithReference(stripeApi).WithEnvironment("ValidIssuer", validIssuer)
    .WithEnvironment("SecretKey", secretKey);
